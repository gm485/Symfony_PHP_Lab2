	...
	<div class="row">
		<div class="col-xs-6">
			...
			<form action="/pets_new.php" method="POST">
				...
				<div class="form-group">
					<label for="pet-breed" class="control-label">Pet Breed</label> <input
						type="text" name="breed" id="pet-breed" class="form-control" />
				</div>
				<div class="form-group">
					<label for="pet-weight" class="control-label">Pet Weight</label> <input
						type="text" name="weight" id="pet-weight" class="form-control" />
				</div>
				<div class="form-group">
				...
				<button type="submit" class="btn btn-primary">
					<span class="glyphicon glypicon-heart"></span> Add
				</button>
			</form>
		</div>
	</div>
